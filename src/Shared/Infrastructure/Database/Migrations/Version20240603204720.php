 ...
 */
final class Version20240603204720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE words_category (id VARCHAR(26) NOT NULL, owner_id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, is_public BOOLEAN NOT NULL DEFAULT false, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE words_learning_history (id VARCHAR(26) NOT NULL, word_id VARCHAR(26) DEFAULT NULL, user_id VARCHAR(255) NOT NULL, step INT NOT NULL, learned_at DATE NOT NULL, INDEX IDX_2EDF2C13E357438D (word_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE words_user (id VARCHAR(26) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE words_category_user (category_id VARCHAR(26) NOT NULL, user_id VARCHAR(26) NOT NULL, INDEX IDX_CB7635AC12469DE2 (category_id), INDEX IDX_CB7635ACA76ED395 (user_id), PRIMARY KEY(category_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE words_category_user ADD CONSTRAINT FK_CB7635AC12469DE2 FOREIGN KEY (category_id) REFERENCES words_user (id)');
        $this->addSql('ALTER TABLE words_category_user ADD CONSTRAINT FK_CB7635ACA76ED395 FOREIGN KEY (user_id) REFERENCES words_category (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE words_category_user DROP FOREIGN KEY FK_CB7635AC12469DE2');
        $this->addSql('ALTER TABLE words_category_user DROP FOREIGN KEY FK_CB7635ACA76ED395');
        ...
        $this->addSql('DROP TABLE words_user');
        $this->addSql('DROP TABLE words_category_user');
